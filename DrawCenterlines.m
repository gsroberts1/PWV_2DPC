...
imwrite(frame2im(frame),[directory filesep 'Centerline3D.png']);
frame = getframe(handles.TraceCoronal);
imwrite(frame2im(frame),[directory filesep 'CoronalTrace.png']);
frame = getframe(handles.TraceSagittal);
imwrite(frame2im(frame),[directory filesep 'SagittalTrace.png']);
